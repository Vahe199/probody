        ...
        return <div className={css['theme--' + theme]}>
            ...
            <div className={cnb(css.body, isMobile ? css.mobile : css.desktop)}>
                ...
                {this.state.step === 2 && <div>
                    ...
                    <TextInput style={{marginTop: 16}} type={'password'} label={t('password')} placeholder={t('enterYourPassword')} value={this.state.password} onUpdate={val => this.setField('password', val)} />
