...
class BlogPage extends React.Component {
    ...
    handlePageChange(page) {
        if (page !== this.state.page
            && page > 0
            && page <= this.state.prefetchedData?.pageCount) {
            ...
            <div style={{marginTop: 32}} bp={'grid'}>
                <div bp={'12 8@md'}>
                    <div bp={'grid'} style={{marginBottom: 12}}>
                        {!Objects.isEmpty(this.state.prefetchedData) && this.state.prefetchedData.articles.map((article, index) =>
                    ...
                    <Paginator page={this.state.page} onChange={this.handlePageChange}
                               pageCnt={this.state.prefetchedData.pageCount}/>
                </div>
                <div bp={'12 4@md'}>
                    <ShareInSocialMedia/>
                </div>
